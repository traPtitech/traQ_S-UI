...
import NewStampPalette from '/@/components/Settings/StampTab/StampPalette/NewStampPalette.vue'
...
const mockUserId = '671f2fbe-89cb-48fe-80dd-e51346ff41f6'

const mockStampPalettes: StampPalette[] = [
  {
